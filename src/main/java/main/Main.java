...
public class Main {
    ...
    private static void ejecutarMochilaFraccionaria() {
        ...
        int W = sc.nextInt();
        double max = MochilaFraccionaria.resolverMochila(items, W);
    ...
    private static void ejecutarMochilaMemoizacion() {
        ...
        System.out.println("Valor máximo (memoización): " + res);
    }
    ...
    private static void ejecutarMochilaTabulacion() {
        ...
        System.out.println("Valor máximo (tabulación): " + res);
    }
}